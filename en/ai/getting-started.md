...
_description: App Builder’s AI Chat capabilities help you build multi-view apps, generate data, themes, and more using natural language.
_keywords: App Builder AI, AI Chat, Infragistics, Ignite UI, AI Generation
---
...
<img class="box-shadow" style="position: relative; left: 50%; transform: translateX(-50%);" src="../images/ai/enty-blog-gif.gif" />
